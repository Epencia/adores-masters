...
export default function StagiaireSansThemeMasters({navigation,item}) {
...
useEffect(()=>{
navigation.setOptions({title: 'Sans thème de stage'});
...
const getListeInscritsStage = async () => {
  setIsLoading(true);
 try {
  const response = await fetch(`https://adores.tech/api/masters/liste-stagiaire-sans-theme.php`, {
    headers: {
