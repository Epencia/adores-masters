...
export default function StagiairesBeneficiairesMasters({navigation,route}) {
...
const getMesStagiaires = async () => {
  setIsLoading(true);
 try {
  const response = await fetch(`https://adores.tech/api/data/liste-demande-stage-matricule.php?matricule=${item.matricule}`, {
    headers: {
