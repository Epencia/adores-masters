...
export default function DemandeStageInactifMasters({navigation,item}) {
...
useEffect(()=>{
navigation.setOptions({title: 'Demandes rejetées'});
...
const getListeInscritsStage = async () => {
  setIsLoading(true);
 try {
  const response = await fetch(`https://adores.tech/api/masters/liste-demande-stage-inactif.php`, {
    headers: {
