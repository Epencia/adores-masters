...
export default function ResumeCreanceMasters({navigation,item}) {
...
useEffect(()=>{
    getSolde();
    navigation.setOptions({ title: 'Résumé des créances' });
...
const getListeUtilisateur = async () => {
  setIsLoading(true);
 try {
  const response = await fetch(`https://adores.tech/api/masters/resume-creance.php`, {
    headers: {
