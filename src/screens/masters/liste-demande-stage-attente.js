...
export default function DemandeStageAttenteMasters({navigation,item}) {
...
navigation.setOptions({title: 'Demandes en attente'});
},[])
...
const getListeInscritsStage = async () => {
  setIsLoading(true);
 try {
  const response = await fetch(`https://adores.tech/api/masters/liste-demande-stage-attente.php`, {
    headers: {
