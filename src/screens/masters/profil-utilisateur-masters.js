...
export default function ProfilScreenMasters({navigation,route}) {
  ...
  // in
    ...
    return (
      ...
      <View style={{backgroundColor:'white' }}> 
        <ScrollView contentContainerStyle={{paddingBottom: 100,flexGrow: 1,justifyContent: 'center',alignItems: 'center',minHeight: remainingHeight}}>
        ...
        {selectedImage ? (
            ...
            item.photo64 ? (
                ...
                <View style={styles.infoContainer}>
                    <Text style={[styles.text, { fontWeight: 300, fontSize: 32 }]}>{item.nom_prenom}</Text>
                    <Text style={[styles.text, { color: "#AEB5BC", fontSize: 14 }]}>{item.role}</Text>
                </View>
 ...
 <View style={styles.form}>
          ...
          <View>
            <Text style={styles.inputLabel}>Nom utilisateur</Text>
            <TextInput 
