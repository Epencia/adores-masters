...
export default function  ListeStagiaireFiliereMasters({navigation,route}) {
...
const getListeInscritsStage = async () => {
  setIsLoading(true);
 try {
  const response = await fetch(`https://adores.tech/api/masters/liste-stagiaire-filiere.php?filiere=${item.code_filiere}`, {
    headers: {
