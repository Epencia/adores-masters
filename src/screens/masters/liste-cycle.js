...
export default function ListeCycleMasters({navigation}) {
...
const intervalId = setInterval(getListeCycle2, delay);
...
const getListeCycle = async () => {
  setIsLoading(true);
 try {
  const response = await fetch(`https://adores.tech/api/masters/liste-cycle.php`, {
    headers: {
    ...
    <FlatList
      ...
      renderItem={({item}) => (
        <View style={styles.experienceItem}>
          <TouchableOpacity  onPress={() => toggleItem(item.code_cycle)}>
...
{expandedItems.includes(item.code_cycle) && (
  
  <View>
    <View style={{marginBottom:20}}></View>
    <TouchableOpacity
      style={styles.followButton} onPress={() => navigation.navigate('Filieres par cycle Masters',{item})}>
      <Text style={styles.followButtonText}>Filières</Text>
    </TouchableOpacity>
    <View style={{marginBottom:10}}></View>
    <TouchableOpacity
      style={styles.followButton2} onPress={() => navigation.navigate('Liste des criteres de notation',{item})}>
      <Text style={styles.followButtonText2}>Critères de notation</Text>
    </TouchableOpacity>
    <View style={{marginBottom:10}}></View>
    <TouchableOpacity
      style={styles.followButton} onPress={() => navigation.navigate('Liste stagiaires par cycle Masters',{item})}>
      <Text style={styles.followButtonText}>Stagiaires</Text>
    </TouchableOpacity>
  </View>
  )}
