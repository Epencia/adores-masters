...
export default function  ListeStagiaireCycleMasters({navigation,route}) {
...
const getListeInscritsStage = async () => {
  setIsLoading(true);
 try {
  const response = await fetch(`https://adores.tech/api/masters/liste-stagiaire-cycle.php?cycle=${item.code_cycle}`, {
    headers: {
