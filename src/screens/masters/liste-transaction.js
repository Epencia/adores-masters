...
export default function TransactionsMasters({navigation,route}){
  ...
  const getTransaction = async () => {
    setIsLoading(true);
   try {
    const response = await fetch(`https://adores.tech/api/data/transaction.php?matricule=${item.matricule}`, {
      headers: {
