...
export default function DemandeStageActifMasters({navigation,item}) {
...
useEffect(()=>{
navigation.setOptions({title: 'Stagiaires validés'});
...
const getListeInscritsStage = async () => {
  setIsLoading(true);
 try {
  const response = await fetch(`https://adores.tech/api/masters/liste-demande-stage-actif.php`, {
    headers: {
