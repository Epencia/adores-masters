...
export default function SoutenanceActifMasters({navigation,item}) {
...
useEffect(()=>{
navigation.setOptions({title: 'Soutenance validée'});
...
const getListeInscritsStage = async () => {
  setIsLoading(true);
 try {
  const response = await fetch(`https://adores.tech/api/masters/liste-soutenance-actif.php`, {
    headers: {
