...
export default function SoutenanceInactifMasters({navigation,item}) {
...
useEffect(()=>{
navigation.setOptions({title: 'Soutenance en attente'});
...
const getListeInscritsStage = async () => {
  setIsLoading(true);
 try {
  const response = await fetch(`https://adores.tech/api/masters/liste-soutenance-attente.php`, {
    headers: {
