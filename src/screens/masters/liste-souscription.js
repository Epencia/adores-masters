...
export default function MesCertificatsMasters({navigation,route}) {
...
// Liste
  const getListeSouscription = async () => {
    setIsLoading(true);
   try {
    const response = await fetch(`https://adores.tech/api/data/liste-souscription.php?matricule=${item.matricule}`, {
      headers: {
...
/>
      ...
      <View style={styles.videoInfo}>
        ...
        <Text style={styles.videoChannel}>{parseFloat(item.prix_souscription).toLocaleString("fr-FR")} F</Text>
