...
export default function TransfertStagiaireMasters({navigation})  {
...
const getListeInscritsStage = () => {
  ...
  fetch(`https://adores.tech/api/masters/liste-demande-stage.php`,{
    method:'post',
      header:{
...
<Text style={styles.label}>Stagiaire * :</Text>
        <View style={styles.pickerContainer}>
          <Picker
            selectedValue={DataStagiaire}
            style={[
              styles.picker,
              errors.DataStagiaire && styles.inputError,
            ]}
            onValueChange={(val) => setDataStagiaire(val)}
          >
