...
export default function DemandeStageEncoursMasters({navigation,item}) {
...
useEffect(()=>{
navigation.setOptions({title: 'Stagiaires en cours'});
...
const getListeInscritsStage = async () => {
  setIsLoading(true);
 try {
  const response = await fetch(`https://adores.tech/api/masters/liste-demande-stage-encours.php`, {
    headers: {
