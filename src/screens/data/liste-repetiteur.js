...
export default function ListeRepetiteur({navigation,route}){
...
useEffect(()=>{
  navigation.setOptions({title: item.niveau});
...
const getListeRepetiteur = async () => {
  setIsLoading(true);
 try {
  const response = await fetch(`https://adores.tech/api/data/liste-repetiteur.php?niveau=${item.niveau}`, {
    headers: {
...
/>
        ...
        <View style={styles.userInfo}>
          ...
          <Text style={styles.userCode}>{item.localite}</Text>
        </View>
