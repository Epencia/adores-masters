...
export default function ChoixFormule({navigation,route}) {
  ...
  // 2
        ...
        const ValidationCertification = (formule) =>{
            ...
            fetch(`https://adores.tech/api/data/certification-compte.php?expediteur=${user[0].matricule}&destinataire=${item.matricule}&formule=${formule}`,{
              method:'post',
                header:{
...
// Erreur et Chargement --fin--
  ...
  return (
    ...
    <ScrollView>
      ...
      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('Messages',{item})}>
          <Text style={styles.buttonText}>Engager une négociation</Text>
        </TouchableOpacity>
