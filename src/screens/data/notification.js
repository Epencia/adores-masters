...
// In des mobile money
    // suppression
    const SuppressionNotification = (arg) =>{
      fetch(`https://adores.tech/api/data/suppression-notification.php?id=${arg}&user=${user[0].id}`,{
        method:'post',
          header:{
...
/>
    ...
    <TouchableOpacity
      ...
      onPress={() => SuppressionNotification(item.id)}>
