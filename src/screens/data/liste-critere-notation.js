    ...
    <FlatList
      ...
      renderItem={({item}) => (
        ...
        <View style={styles.userInfo}>
          <Text style={styles.userName}>{item.libelle_critere}</Text>
          <Text style={styles.userCode}>{item.notation_critere} points</Text>
        </View>
        
        {expandedItems.includes(item.id_critere) && (
          <View>
        <Text style={styles.description}>{item.details_critere}</Text>
        </View>
      )}
