...
const getValidationFormation = () =>{
  ...
  fetch(`https://adores.tech/api/data/validation-formation.php?id=${item.id_formation}&matricule=${user[0].matricule}&prix=${item.PrixCertifie}`,{
    method:'post',
    header:{
...
/>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerRow}>
            ...
            {item.taux > 0 ? (
            <Text style={styles.headerPrice}> {parseFloat(item.PrixCertifie).toLocaleString("fr-FR")} F</Text>
            ) : (
        ...
        <View style={styles.about}>
          ...
          <View style={styles.btn}>
            <Text style={styles.btnText}>Effectuer le paiement</Text>
          </View>
        </TouchableOpacity>
      ...
      <RBSheet
        ...
        <View style={styles.sheetHeader}>
          <Text style={styles.sheetHeaderTitle}>Details du paiement</Text>
        </View>
        ...
        <View style={styles.sheetRow}>
          <View style={styles.sheetRowItem}>
            <Text style={styles.sheetLabel}>Frais</Text>

            <View style={styles.sheetValue}>
              <Text style={styles.sheetValueText}>0 f</Text>
            </View >
          </View>

          <View style={styles.sheetRowItem}>
            <Text style={styles.sheetLabel}>Total montant</Text>

            <View style={styles.sheetValue}>
              <Text style={styles.sheetValueText}>{parseFloat(item.PrixCertifie).toLocaleString("fr-FR")} f</Text>
            </View >
          </View>
        </View>
