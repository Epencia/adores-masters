...
const SECTIONS = [
  {
    ...
    icon: 'settings',
    items: [
      { icon: 'account-group', color: '#fe9400', label: 'Coachs certifiés', src: 'Liste des utilisateurs' },
      {icon: 'account-heart',color: '#fe9400',label: 'Ambassadeurs',src: 'Liste des ambassadeurs',},
      {icon: 'account-plus',color: '#fe9400',label: 'Membres',src: 'Mes membres',},
      { icon: 'account-multiple-check-outline', color: '#fe9400', label: 'Stagiaires', src: 'Mes stagiaires' },
  ...
  },
  {
    ...
    items: [
      ...
      {icon: 'card-account-details-star-outline',color: '#007afe',label: 'Epargnes',src: 'Epargnes',},
  ...
  },
  {
    ...
    items: [
      ...
      {icon: 'book',color: '#fd2d54',label: 'Etudes',src: 'Categorie Formations',},
  ...
  },
  {
    ...
    icon: 'align-center',
    items: [
      {icon: 'comment',color: '#32c759',label: 'Messagerie',src: 'Maitre de stage',},
      ...
      {icon: 'folder-open',color: '#32c759',label: 'Déconnexion',src: 'Deconnexion',},
    ],
  },
];
