            ...
            {[
              {
                ...
                label: 'Menu Stages',
                company: 'Cliquez-ici',
                jobType: 'Découvrez ce menu pour vos stages',
                src: 'Menu stage',
              ...
              },
              {
                ...
                label: 'Menu Etudes',
                company: 'Cliquez-ici',
                jobType: 'Découvrez ce menu pour vos études',
                src: 'Menu etudes',
              ...
              },
              {
                ...
                label: 'Menu Services',
                company: 'Cliquez-ici',
                jobType: 'Découvrez ce menu pour divers services',
                src: 'Menu services',
        ...
        <View style={styles.list2}>
              <View>
                <View style={styles.card2}>
                  <View style={styles.cardTop}>
                    <View style={styles.cardIcon}>
                      <MaterialCommunityIcons color="#000" name="credit-card" size={24}/>
                    </View>
                    <View style={styles.cardBody}>
        ...
        <View style={styles.list2}>
              <TouchableOpacity
                ...
                <View style={styles.card2}>
                  <View style={styles.cardTop}>
                    <View style={styles.cardIcon}>
                      <MaterialCommunityIcons color="#000" name="video" size={24}/>
                    </View>
                    <View style={styles.cardBody}>
                      <Text style={styles.cardTitle}>Tutoriels</Text>
              ...
              <View>
                <View style={styles.card2}>
                  <View style={styles.cardTop}>
                    ...
                    <View style={styles.cardBody}>
                      <Text style={styles.cardTitle}>Vie professionnelle</Text>
