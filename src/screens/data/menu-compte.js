...
<View style={styles.container}>
       ...
       <Text style={styles.balanceTitle2}>Aucune formule</Text>
        ...
        <View>
            ...
            <Text style={styles.balanceTitle}>
              {showBalance
          ? user[0].solde.toString().replace(/\d/g, '*')
          : parseFloat(user[0].solde).toLocaleString('fr-FR')}{' '}
        ...
        <View>
            <Text style={styles.balanceText}>Solde Epargne</Text>
            {SoldeTotal && SoldeTotal.length > 0 && !isNaN(parseFloat(SoldeTotal[0].solde)) ? (
            <Text style={styles.balanceTitle}>
              {showBalance
            ...
            <ScrollView
              ...
              {items.map(({ img, name,src }, index) => {
                ...
                <TouchableOpacity
                  ...
                  <View style={[styles.card, {  borderWidth: 1,backgroundColor: 'white',borderColor: '#007BFF',}]}>
      ...
      <View style={styles.overlay}>
        <View style={styles.footer}>
          <TouchableOpacity
             onPress={() => navigation.navigate('Liste des ambassadeurs')}>
            <View style={styles.btn}>
              <Text style={styles.btnText}>Certifications</Text>
            </View>
          </TouchableOpacity>

          <TouchableOpacity
            onPress={() => navigation.navigate('Epargnes')}
            style={{ flex: 1, paddingHorizontal: 8 }}>
            <View style={styles.btnSecondary}>
              <Text style={styles.btnSecondaryText}>Epargnes</Text>
