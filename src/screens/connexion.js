...
export default function LoginScreen({navigation})  {
    ...
    const login = async () => {
      ...
      setIsSubmitting(false);
          ...
          setUser(data);
          // ADMIN
          if (data[0].role === 'Superviseur' || data[0].role === 'Administrateur' || data[0].role === 'Assistant') {
            navigation.navigate('Dashboard Masters');
          } 
          // BENEFICIAIRE
...
{isSubmitting && (
  <ActivityIndicator size="large" color="blue" />
            ...
            <View style={styles.btnGroup}>
              <TouchableOpacity
                onPress={() => navigation.navigate('Site internet')}
                ...
                <View style={styles.btnFacebook}>
                  ...
                  <Text style={styles.btnFacebookText}>Site web</Text>
                </View>
              </TouchableOpacity>
