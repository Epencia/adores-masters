  ...
  return (
    ...
    >
      ...
      <Tab.Screen
        ...
        options={({ navigation }) => ({
          tabBarIcon: ({ color, size }) => (
            <Icon name="home" color={color} size={29} />
          ),
          headerTitle: () => (
      ...
      <Tab.Screen
        ...
        options={({ navigation }) => ({
          tabBarIcon: ({ color, size }) => (
            <Icon name="explore" color={color} size={29} />
          ),
          headerTitle: () => (
            <CustomHeader navigation={navigation} />
      ...
      <Tab.Screen
        ...
        options={({ navigation }) => ({
          tabBarIcon: ({ color, size }) => (
            <Icon name="apps" color={color} size={29} />
          ),
          headerTitle: () => (
            <CustomHeader navigation={navigation} />
      ...
      <Tab.Screen
        ...
        options={({ navigation }) => ({
          tabBarIcon: ({ color, size }) => (
            <Icon name="person-add" color={color} size={29} />
          ),
          headerTitle: () => (
            <CustomHeader navigation={navigation} />
      ...
      <Tab.Screen
        ...
        options={({ navigation }) => ({
          tabBarIcon: ({ color, size }) => (
            <Icon name="video-library" color={color} size={29} />
          ),
          headerTitle: () => (
            <CustomHeader navigation={navigation} />
